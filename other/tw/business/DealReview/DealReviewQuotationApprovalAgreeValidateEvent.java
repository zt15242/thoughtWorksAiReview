...
public class DealReviewQuotationApprovalAgreeValidateEvent implements ApprovalEvent {
...
//        request.getDataId();
        ...
        try {
            ...
            boolean financeFail = responsibilities.toString().contains("\"code\":\"finance\"") && dealReview.getSold_Margin__c()==null;

            if(financeFail){
                response.setSuccess(false);
                response.setMsg("Sold CGM% required");
            }else{
