...
public class ApprovalAgreeAfterEventDealReview implements ApprovalEvent {
    ...
    private void agreeAfter(ApprovalEventRequest request) {
        ...
        try {
            ...
            String res = CommonInterfaceUtil.sendInterfaceRequest("NoPoCRMtoJigsaw", idList, "outbound");
